...
public class Mailer {
	...
	public static void main(String args[]) {
		try {
			...
			String user = "seleniumguys@gmail.com";
			String pass = "selenium$1";
			String to = "ankit.patel@eclinicalworks.com";
			String cc = "saffin.shivani@eclinicalworks.com";

			String from = "noreply@reports.com";
			String subject = "change log report";
			String messageText = ReadFromTxt.ReadTxt();
